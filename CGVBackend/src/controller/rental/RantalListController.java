...
public class RantalListController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 페이징을 위한 로직 시작]
		// 전체 레코드 수
		int totalRecordCount = dao.getTotalRantalRecord();
		...
		String pagingString = PagingUtil.pagingText(totalRecordCount, pageSize, blockPage, nowPage,
				req.getServletContext().getContextPath() + "/rental/rental.list.cgv?");
		List list = dao.selectRentalList(start, end);
		...
		req.getRequestDispatcher("/rental/rental_List.jsp").forward(req, resp);
