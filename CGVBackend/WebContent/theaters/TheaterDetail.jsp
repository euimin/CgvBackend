...
<%
	...
	System.out.println(request.getAttribute("editError"));
	if(request.getAttribute("editError") == null){
		BackendDAO dao = new BackendDAO(application);
		TheaterDto dto = dao.selectOneTheater(theater_code);
    	...
    	<table class="table">
            <tbody>
              ...
              <tr>
                <td>주소</td>
                <td>	
					<input class="btn btn-default" type="button" onclick="sample6_execDaumPostcode()" value="주소 찾기"/><br>
					주소1(도로명 주소)<br/>
              ...
              <tr>
              	<td colspan="2">
              		...
              		<input class="btn btn-primary" type="submit" value="수정"/>${editError}
              	</td>
              </tr>          
            </tbody>
          </table>
